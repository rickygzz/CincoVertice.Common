...
/// <summary>
///     Used by RegisterHotKey. The keys that must be pressed in combination with the key specified by the uVirtKey
///     parameter in order to generate the WM_HOTKEY message. The fsModifiers parameter can be a combination of the
///     following values.
/// </summary>
[Flags]
